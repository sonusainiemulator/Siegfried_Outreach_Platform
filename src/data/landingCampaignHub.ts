...
export const campaignHubFaqs = [
  ...
  },
  {
    ...
    description:
      'Yes! We provide native two-way synchronization with Perfex CRM, custom webhooks, REST APIs, and a dedicated Model Context Protocol (MCP) server. You can connect your Siegfried Outreach workflows directly with Claude Code, Cursor, Windsurf, Antigravity, and n8n/Hermes autonomous pipelines with zero setup friction.',
  },
  {
    id: 'faq-6',
