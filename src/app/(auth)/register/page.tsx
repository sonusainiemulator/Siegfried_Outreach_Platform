    ...
    <div className="space-y-8 animate-in fade-in duration-1000">
      ...
      >
        ...
        <div className="relative bg-white/95 dark:bg-gradient-to-b dark:from-[#15171C]/95 dark:to-black/95  backdrop-blur-3xl rounded-[inherit] p-4 sm:p-8 transition-all duration-500 overflow-hidden border-none text-left">
          ...
          >
            <h1 className="text-3xl font-medium text-title-color dark:text-white mb-2 ">{t('create_account')}</h1>
            <p className="text-subtitle-color font-medium text-base max-w-[340px] md:max-w-none mx-auto md:mx-0 mb-4">
              {t('get_started_pixel')}
            </p>
          </motion.div>
          <RegisterForm />
