...
import { useGetCodeHistoryQuery } from '@/redux/api/aiContentApi'
...
const CodeHistoryPage = () => {
  ...
  const { data: historyData, isLoading, isFetching } = useGetCodeHistoryQuery({ page, limit: 10 })
      ...
      <main className="flex-1 overflow-y-auto pt-3 custom-scrollbar">
        <div className="max-w-[1600px] mx-auto">
          {filteredHistory.length > 0 || isLoading ? (
            ...
            <HistoryEmptyState startRoute={ROUTES.CODE_ASSISTANT} />
          )}
        </div>
      </main>
