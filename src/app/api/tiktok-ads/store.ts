...
export const INITIAL_TIKTOK_CAMPAIGNS: TikTokCampaignRecord[] = [
  {
    ...
    creative: {
      ...
      soundTitle: 'Original Sound - TTOS Viral Beats (Trending)',
      hashtags: ['#TikTokMadeMeBuyIt', '#SummerStyle', '#ViralProduct', '#MustHave'],
      brandHandle: '@ttos_outreach',
      landingPageUrl: 'https://ttos.com/shop',
  ...
  },
  {
    ...
    creative: {
      ...
      brandHandle: '@ttos_outreach',
      landingPageUrl: 'https://ttos.com/demo',
    },
    insights: {
      spend: 1420.00,
      impressions: 295000,
  ...
  },
  {
    ...
    creative: {
      ...
      soundTitle: 'TTOS Hype Remix (Bass Boosted)',
      hashtags: ['#CreatorEconomy', '#UGC', '#TechReview', '#AITools'],
      brandHandle: '@ttos_outreach',
      landingPageUrl: 'https://ttos.com',
    },
    insights: {
      spend: 640.20,
      impressions: 380000,
  ...
  },
  {
    ...
    creative: {
      ...
      brandHandle: '@ttos_outreach',
      landingPageUrl: 'https://apps.apple.com/app/ttos-outreach',
    },
    insights: {
      spend: 920.00,
      impressions: 210000,
