...
const clientQuickPresets = [
  {
    id: 'claude-code',
    label: 'Claude Code',
    cmd: 'claude mcp add --transport http Siegfried Outreach https://api.siegfriedoutreach.com/mcp',
  },
  {
    id: 'cursor',
    label: 'Cursor JSON',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-lg sm:text-xl text-gray-300 font-normal leading-relaxed max-w-3xl mx-auto">
            ...
            <strong className="text-white font-semibold">Siegfried Outreach MCP closes that gap</strong>. 32 official tools,
