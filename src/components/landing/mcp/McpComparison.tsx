      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight font-outfit">
            How Does Siegfried Outreach MCP Compare to Other Servers?
          </h2>
          <p className="text-gray-400 text-base sm:text-lg">
            Compare Siegfried Outreach against other social media automation APIs and MCP servers.
          </p>
        </div>
              ...
              <tbody className="divide-y divide-white/5">
                {mcpComparisonData.map((row: any, idx: number) => (
                  <tr key={idx} className="hover:bg-white/[0.02] transition-colors">
                    ...
                    {/* Siegfried Outreach column (highlighted) */}
