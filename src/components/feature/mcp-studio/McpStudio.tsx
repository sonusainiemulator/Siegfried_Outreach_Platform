...
const EXTENDED_CLIENT_GUIDES = [
  {
    ...
    instructions: [
      ...
      'Click Connect and approve access. Claude will now recognize all 32 Siegfried Outreach social tools.',
    ],
    samplePrompts: [
  ...
  },
  {
    ...
    getConfig: (_key: string) =>
      'claude mcp add --transport http Siegfried Outreach https://api.siegfriedoutreach.com/mcp',
    instructions: [
      'Open your terminal where Claude Code CLI is installed.',
      'Run the single command shown below to register the Siegfried Outreach MCP server.',
  ...
  },
  {
    ...
    instructions: [
      ...
      'Add a new server named "siegfriedoutreach".',
  ...
  },
  {
    ...
    name: 'Siegfried Outreach In-App Chat Assistant',
    badge: 'Built-in Native Chat',
    icon: 'Sparkles',
    recommended: true,
    transport: 'Native Internal Bridge',
    endpoint: 'In-App Dashboard',
    description: 'Use the built-in Siegfried Outreach AI Chat Assistant with zero setup required—MCP tools are pre-integrated!',
    ...
    instructions: [
      ...
      'Click the button below to navigate directly to the Siegfried Outreach AI Chat Assistant.',
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="p-6 sm:p-8 rounded-2xl bg-card border border-border space-y-3 shadow-xs">
            ...
            <h2 className="text-2xl font-bold text-foreground font-outfit">
              How Talent & Social Media Managers Use Siegfried Outreach MCP
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="p-6 rounded-xl bg-card border border-border space-y-3 shadow-xs">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                The assistant calls Siegfried Outreach MCP tools in real-time. Posts are queued, carousels are published, and comments are answered safely.
              </p>
            </div>
          </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground pt-1">
                  Copy these battle-tested prompts directly into your connected chat assistant or run directly in Siegfried Outreach.
                </p>
              </div>
          ...
          <div className="rounded-2xl bg-card border border-border p-6 sm:p-8 space-y-6 shadow-xs">
            <div>
              ...
              <p className="text-xs text-muted-foreground pt-1">
                Overview of what your AI chat assistant can do on each connected network via Siegfried Outreach MCP.
              </p>
            </div>
