            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl border border-border bg-card/40 mt-4 backdrop-blur-md">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    If enabled, Siegfried Outreach AI will autonomously generate monthly content plans, write captions, generate creatives, and publish them to your social channels 24/7.
                  </p>
                </div>
              </div>
            </div>
