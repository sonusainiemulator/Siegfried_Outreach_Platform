...
export const CommandPalette: React.FC<CommandPaletteProps> = ({ open, onOpenChange }) => {
  ...
  const allCommands = useMemo<CommandItem[]>(() => [
    ...
    },
    {
      ...
      description: 'AI viral hooks, Spark Ads, and TikTok Shop conversion campaigns',
      category: 'pages',
      icon: Video,
      keywords: ['ads', 'tiktok ads', 'spark ads', 'tiktok shop', 'video ads', 'campaigns', 'tiktok'],
      path: '/social-media/tiktok-ads',
    },
    {
      id: 'page-reddit-ads',
      title: 'Reddit Ads Manager',
      description: 'Subreddit community targeting, promoted discussions, and Reddit Pixel',
      category: 'pages',
      icon: Globe,
      keywords: ['ads', 'reddit ads', 'subreddits', 'promoted posts', 'campaigns', 'reddit'],
      path: '/social-media/reddit-ads',
    },
    {
      id: 'page-google-ads',
      title: 'Google Ads Manager',
      description: 'Intent-driven Search Ads, Performance Max (PMax), and Google Tag',
      category: 'pages',
      icon: Search,
      keywords: ['ads', 'google ads', 'search ads', 'pmax', 'performance max', 'keywords', 'google'],
      path: '/social-media/google-ads',
    },
    {
    ...
    {
      id: 'page-mcp-studio',
      title: 'MCP Protocol & Agent Studio',
      description: 'Connect Claude Desktop, Cursor, ChatGPT & external AI assistants to 9 social networks',
      category: 'tools',
      icon: Cpu,
      keywords: ['mcp', 'claude', 'cursor', 'chatgpt', 'codex', 'antigravity', 'windsurf', 'assistants', 'agent', 'protocol'],
      path: '/mcp-studio',
      badge: '28 Tools',
    },
    {
        ...
        <DialogContent className="sm:max-w-2xl p-0 overflow-hidden bg-white/95 dark:bg-zinc-950/95 backdrop-blur-2xl border border-zinc-200 dark:border-zinc-800/80 rounded-2xl shadow-2xl gap-0 z-[100] animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="flex items-center justify-between px-4 py-2.5 border-t border-zinc-200 dark:border-zinc-800/80 bg-zinc-50/70 dark:bg-zinc-900/60 text-[11px] text-muted-foreground">
            ...
            <div className="flex items-center gap-1 text-primary font-bold">
              <Sparkles className="w-3.5 h-3.5" /> Siegfried Outreach Command 2.0
            </div>
          </div>
        </DialogContent>
      </Dialog>
